...
public class BaseControllerAdvice {
    ...
    public Object badPasswordException(BadPasswordException badPasswordException, WebRequest webRequest) {
        return response(HttpStatus.INTERNAL_SERVER_ERROR, badPasswordException, webRequest);
    }
